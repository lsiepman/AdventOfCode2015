...
unique_sequences.columns = ["start", "step1", "step2", "step3", "step4", "step5", "step6", "end"]
...
def CalcDist(data, df):
    ...
    for i in tqdm(range(len(df))):
        ...
        dist1 = data.loc[(data["From"] == start) & (data["To"] == step1), ["Distance"]].iloc[0]["Distance"]
        dist2 = data.loc[(data["From"] == step1) & (data["To"] == step2), ["Distance"]].iloc[0]["Distance"]
        dist3 = data.loc[(data["From"] == step2) & (data["To"] == step3), ["Distance"]].iloc[0]["Distance"]
        dist4 = data.loc[(data["From"] == step3) & (data["To"] == step4), ["Distance"]].iloc[0]["Distance"]
        dist5 = data.loc[(data["From"] == step4) & (data["To"] == step5), ["Distance"]].iloc[0]["Distance"]
        dist6 = data.loc[(data["From"] == step5) & (data["To"] == step6), ["Distance"]].iloc[0]["Distance"]
        dist7 = data.loc[(data["From"] == step6) & (data["To"] == end), ["Distance"]].iloc[0]["Distance"]
