...
for combination in itertools.product(
    weapons.Item.tolist(), armor.Item.tolist(), rings.Item.tolist(), rings.Item.tolist()
):
...
def SimulateFight(weapon, armor_item, ring1, ring2, result, nr):
    ...
    hp = 100
    damage = (
        weapons.loc[weapons["Item"] == weapon]["Damage"].iloc[0]
        + rings.loc[rings["Item"] == ring1]["Damage"].iloc[0]
        + rings.loc[rings["Item"] == ring2]["Damage"].iloc[0]
    )
    defense = (
        armor.loc[armor["Item"] == armor_item]["Armor"].iloc[0]
        + rings.loc[rings["Item"] == ring1]["Armor"].iloc[0]
        + rings.loc[rings["Item"] == ring2]["Armor"].iloc[0]
    )
    ...
    costs = (
        weapons.loc[weapons["Item"] == weapon]["Cost"].iloc[0]
        + rings.loc[rings["Item"] == ring1]["Cost"].iloc[0]
        + rings.loc[rings["Item"] == ring2]["Cost"].iloc[0]
        + armor.loc[armor["Item"] == armor_item]["Cost"].iloc[0]
    )
